 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:888/songs?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://service/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:888/songs?wsdl");
